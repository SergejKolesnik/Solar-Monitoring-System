...
def load_base_from_sheets():
        try:
                    ...
                    # Конвертуємо числові колонки включно з AI_Forecast_MW
                    num_cols = ['Forecast_MW', 'CloudCover', 'Temp', 'WindSpeed',
                                'PrecipProb', 'Fact_MW', 'Capacity_MW', 'AI_Forecast_MW']
                    for col in num_cols:
...
if not df_f.empty:
        ...
        with tabs[0]:
            ...
            try:
                ...
                # Для відображення в графіку — мержимо з df_f за часом
                ...
                # Зберігаємо також live-прогноз моделі як AI_MW для порівняння в UI
