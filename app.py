...
st.sidebar.markdown(f"*Прогноз для **{capacity_mw} МВт***")

# --- Заголовок ---
st.title("☀️ SkyGrid Solar AI")
st.caption(f"Прогноз для СЕС потужністю **{capacity_mw} МВт** · Нікополь")
